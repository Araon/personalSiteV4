...
export default function Navigation() {
  ...
  return (
    <header className={clsx("relative top-0 z-20 bg-primary md:sticky")}>
      <nav className="lg mx-auto flex max-w-[700px] items-center justify-between gap-3 px-4 py-3 md:px-6" aria-label="Main navigation">
        ...
        <Popover className="relative ml-auto md:hidden">
          {({ open }: { open: boolean }) => (
            <>
              <Popover.Button 
                className="flex border-2 border-[#0a76a8] items-center gap-1 rounded-lg p-1.5 text-secondary focus:ring-0 focus-visible:outline-none"
                aria-expanded={open}
